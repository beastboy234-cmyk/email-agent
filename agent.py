...
class EmailAgent:
    ...
    def get_tool_definitions(self):
        ...
        return [
            ...
            },
            {
                "type": "function",
                "function": {
                    "name": "detect_spam_emails",
                    "description": "Detect and list spam and marketing emails in your inbox",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "query": {
                                "type": "string",
                                "description": "Search query to find emails (optional, defaults to inbox)",
                            },
                            "max_results": {
                                "type": "integer",
            ...
            },
            {
                "type": "function",
                "function": {
                    "name": "delete_spam_emails",
                    "description": "Delete spam emails from your inbox",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "query": {
                                "type": "string",
                                "description": "Search query to find spam emails (optional)",
                            },
                        },
                        "required": [],
                    },
            ...
            },
            {
                "type": "function",
                "function": {
                    "name": "delete_marketing_emails",
                    "description": "Delete or archive marketing and promotional emails",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "query": {
                                "type": "string",
                                "description": "Search query to find marketing emails (optional)",
                            },
                            "auto_delete": {
                                "type": "boolean",
                                "description": "If true, delete emails; if false, archive them",
                                "default": False,
                            },
                        },
                        "required": [],
    ...
    def execute_tool(self, tool_name: str, tool_input: dict) -> str:
        ...
        elif tool_name == "detect_spam_emails":
            return self.email_tools.detect_spam_emails(
                tool_input.get("query", ""),
                tool_input.get("max_results", 20),
            )
        elif tool_name == "delete_spam_emails":
            return self.email_tools.delete_spam_emails(tool_input.get("query", ""))
        elif tool_name == "delete_marketing_emails":
            return self.email_tools.delete_marketing_emails(
                tool_input.get("query", ""),
                tool_input.get("auto_delete", False),
            )
...
- Detecting and deleting spam and marketing emails
...
For spam and marketing detection:
- Use detect_spam_emails to find spam and marketing emails
- Use delete_spam_emails to remove identified spam
- Use delete_marketing_emails to remove marketing/promotional emails
